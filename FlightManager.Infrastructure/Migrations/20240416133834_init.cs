    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FlightID = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "NEWSEQUENTIALID()"),
                    Number = table.Column<int>(type: "int", nullable: true),
                    DepartureDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DepartureAirport = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "AircraftTypes",
                columns: new[] { "AircraftTypeID", "Name" },
                values: new object[,]
                {
                    { new Guid("46754cfe-7dc0-4ebb-a67c-b8970ccebb9b"), "Airbus" },
                    { new Guid("ac14fd42-9d4c-47b9-a989-4832e3843a0c"), "Bombardier" },
                    { new Guid("dd0c5eaa-811a-4ebd-8952-9268c93a20b0"), "Embraer" },
                    { new Guid("fc2b874f-45fd-42b1-9d4a-11e9b1b0413a"), "Boeing" }
                });
